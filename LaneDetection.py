...
if __name__ == '__main__':
    ...
    if sys.version_info[0] < 3:
        ...
        path_to_vs_dll = r'E:\CarSim2024.1_Prog\Database\RL_VISION\Highway_Lane_Detection\vs_lv_ds_x64.dll'
        error_occurred = 1
                            ...
                            while status == 0:
                                ...
                                while status == 0:
                                    ...
                                    if j == 100: # only process every 100
                                        ...
                                        import_array = [swa]
                                        swa = 5.0
                                        cv2.putText(image_np, f"Time: {t_current:.2f} s", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
                                    j = j + 1
